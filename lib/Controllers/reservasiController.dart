...
class ReservasiController {
  static const baseUrl = 'http://192.168.1.12:3000/api/reservasi';

  static Future<bool> tambahReservasi(Map<String, dynamic> data) async {
    final res = await http.post(Uri.parse(baseUrl), body: jsonEncode(data), headers: {'Content-Type': 'application/json'});
    return res.statusCode == 201;
  }

  static Future<List<dynamic>> getReservasi() async {
